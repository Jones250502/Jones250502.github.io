const robotPlanningRlContent = {
  ...
  en: {
    ...
    subtitle: "Planning and learning in simulation",
    category: "Master Thesis",
    type: "Master thesis",
    period: "Ongoing",
    status: "Ongoing",
    cover: "assets/projects/robot-planning-rl/cover.jpg",
    summary: "Master's thesis project in robot-based planning with reinforcement learning. The focus is on modeling, training and simulation-based evaluation of planning strategies.",
    focus: ["Isaac Sim", "Isaac Lab", "Python", "Reinforcement Learning"],
    tools: ["Isaac Sim", "Isaac Lab", "Python", "Reinforcement Learning"],
    timeline: [
