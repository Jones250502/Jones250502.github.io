const orderAutomationContent = {
  ...
  en: {
    ...
    subtitle: "Data extraction and process logic",
    category: "Company Project",
    type: "Company project",
    period: "Placeholder period",
    status: "Completed",
    cover: "assets/projects/order-automation/cover.jpg",
    summary: "Automation of order processes with focus on data extraction, process logic and reliable transfer into existing systems.",
    focus: ["Python", "Power Automate", "ERP", "Automation"],
    tools: ["Python", "Power Automate", "ERP", "Automation"],
    timeline: [
